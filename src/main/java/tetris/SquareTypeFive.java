 ...
 * @author Lei Gao
 */
public class SquareTypeFive extends SquareObject {

	/** Creates a new instance of SquareTypeOne */
	public SquareTypeFive(int x, int y, int size) {
		super(x, y, size);
		S[0] = new Square(iniX, iniY, 15);
		S[1] = new Square(iniX, iniY - size, 15);
		S[2] = new Square(iniX - size, iniY, 15);
		S[3] = new Square(iniX - size * 2, iniY, 15);
	}

	public SquareTypeFive(int size) {
		super(size);
		S[0] = new Square(iniX, iniY, 15);
		S[1] = new Square(iniX, iniY - size, 15);
		S[2] = new Square(iniX - size, iniY, 15);
